                            ...
                            if (_orderAmount <
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                  content: Text(getTranslated(
                                          'Minimum order amount is', context) +
                                      '${PriceConverter.convertPrice(context, Provider.of<SplashProvider>(context, listen: false).configModel.minimumOrderValue)},' +
                                      getTranslated('you have', context) +
                                      '${PriceConverter.convertPrice(context, _orderAmount)}' +
                                      getTranslated(
