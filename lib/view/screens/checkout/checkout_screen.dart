  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      Provider.of<OrderProvider>(context, listen: false)
          .initializeTimeSlot(_open, _close);
                                        ...
                                        if (order.timeSlots == null ||
                                          ...
                                          DateTime _date =
                                              order.selectDateSlot == 0
                                                  ...
                                                  : DateTime.now()
                                                      .add(Duration(days: 1));
                                          DateTime _time = order
                                              .timeSlots[order.selectTimeSlot]
                                              .startTime;
                                              ...
                                              .showSnackBar(SnackBar(
                                                  content: Text(
                                                    getTranslated(
                                                            ...
                                                            context) +
                                                        '${Provider.of<SplashProvider>(context, listen: false).configModel.minimumOrderValue}',
                                                  ),
